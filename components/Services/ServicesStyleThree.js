...
export default class ServicesStyleThree extends Component {
    render() {
        return (
                                ...
                                <div className="row m-0">
                                    ...
                                    <div className="col-lg-6 col-md-12 p-0">
                                        <div className="image bg-5">
                                            <img src="/images/marketing-agency/services-img5.jpg" alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row m-0">
                                    ...
                                    <div className="col-lg-6 col-md-12 p-0">
                                        <div className="image bg-6">
                                            <img src="/images/marketing-agency/services-img6.jpg" alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
